      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        <div className="hover:shadow-md hover:shadow-[#040c16]">
          <div className="bg-white rounded-lg shadow-lg">
            ...
            <div className="py-6 px-4">
              <h3 className="text-lg font-medium text-gray-900">88 HumberLine Drive</h3>
              <p className="text-sm text-gray-500">3 bd | 2 ba | 1,500 sqft</p>
              <p class="text-lg font-bold text-gray-700 mt-4"><del>$900,000</del> On Sale Now: $825,000</p>
        ...
        <div className="hover:shadow-md hover:shadow-[#040c16]">
          <div className="bg-white rounded-lg shadow-lg">
            ...
            <div className="py-6 px-4">
              <h3 className="text-lg font-medium text-gray-900">93 Finch Ave</h3>
              <p className="text-sm text-gray-500">4 bd | 3 ba | 2,000 sqft</p>
              <p class="text-lg font-bold text-gray-700 mt-4"><del>$1,100,000</del> On Sale Now: $950,000</p>
              <button className="mt-6 px-4 py-2 bg-amber-800 text-white rounded-md hover:bg-amber-700">
                View Details
              </button>
            </div>
        ...
        <div className="hover:shadow-md hover:shadow-[#040c16]">
          <div className="bg-white rounded-lg shadow-lg">
            ...
            <div className="py-6 px-4">
              <h3 className="text-lg font-medium text-gray-900">64 CottonCloud Street</h3>
              <p className="text-sm text-gray-500">2 bd | 1 ba | 1,000 sqft</p>
              <p class="text-lg font-bold text-gray-700 mt-4"><del>$600,000</del> On Sale Now: $500,000</p>
              <button className="mt-6 px-4 py-2 bg-amber-800 text-white rounded-md hover:bg-amber-700">
                View Details
              </button>
            </div>
