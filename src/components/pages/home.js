      ...
      <div className="max-w-7xl mx-auto md:flex md:flex-row-reverse md:items-center">
        ...
        <div className="md:w-1/2 md:pl-8">
          <div className="text-center md:text-left">
            <h1 className="text-4xl font-bold text-gray-800 mb-6">Find Your Perfect Property with <span className="text-amber-800">Tejz Properties</span></h1>
            <p className="text-lg text-gray-700 mb-8">
            At Tejz Properties, we make real estate simple, seamless, and successful. Whether you're searching for your dream home, an investment opportunity, or the perfect commercial space, we’re here to guide you every step of the way.
            </p>
